...
```--rename```: asks the SLM to suggest better filenames when sorting. Turns `IMG_20260410_092340.jpg` into something like `Beach-Sunset.jpg`. Works with `--dry-run` to preview renames before applying.
